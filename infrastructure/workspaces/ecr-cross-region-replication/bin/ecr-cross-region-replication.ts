...
import { EcrCrossRegionReplicationStage } from 'lib/stages/ecr-cross-region-replication-stage';
...
const stage = new EcrCrossRegionReplicationStage(app, `${pascalCase(envName)}`, {
  project: pjName,
  environment: envName,
  env: defaultEnv,
