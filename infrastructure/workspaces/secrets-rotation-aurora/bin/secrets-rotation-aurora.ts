...
import { SecretsRotationAuroraStage } from 'lib/stages/secrets-rotation-aurora-stage';
...
const stage = new SecretsRotationAuroraStage(app, `SecretsRotationAurora${pascalCase(envName)}`, {
  project: pjName,
  environment: envName,
  env: defaultEnv,
