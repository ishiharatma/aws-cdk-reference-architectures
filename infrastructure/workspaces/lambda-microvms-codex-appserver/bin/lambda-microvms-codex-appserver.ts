...
import { LambdaMicrovmsCodexAppserverStage } from 'lib/stages/lambda-microvms-codex-appserver-stage';
...
const stage = new LambdaMicrovmsCodexAppserverStage(app, `LambdaMicrovmsCodexAppserver${pascalCase(envName)}`, {
  project: pjName,
  environment: envName,
  env: defaultEnv,
