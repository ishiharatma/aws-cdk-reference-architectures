...
import { ApigwSinglePurposeLambdaStage } from 'lib/stages/apigw-single-purpose-lambda-stage';
...
const stage = new ApigwSinglePurposeLambdaStage(app, `ApigwSinglePurposeLambda${pascalCase(envName)}`, {
  project: pjName,
  environment: envName,
  env: defaultEnv,
