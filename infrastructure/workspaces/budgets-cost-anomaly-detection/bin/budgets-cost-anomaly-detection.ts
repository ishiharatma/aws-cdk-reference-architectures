...
import { BudgetsCostAnomalyDetectionStage } from 'lib/stages/budgets-cost-anomaly-detection-stage';
...
const stage = new BudgetsCostAnomalyDetectionStage(app, `${pascalCase(envName)}`, {
    project: pjName,
    environment: envName,
    env: defaultEnv,
