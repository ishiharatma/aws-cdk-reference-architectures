...
import { CloudfrontS3StaticWebsiteStage } from 'lib/stages/cloudfront-s3-static-website-stage';
...
const stage = new CloudfrontS3StaticWebsiteStage(app, `CloudFrontS3${pascalCase(envName)}`, {
  project: pjName,
  environment: envName,
  env: defaultEnv,
